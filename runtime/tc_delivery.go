...
// setting had before sing-ebpf touched it. The first original is therefore the
...
// it for someone else's change, and leave sing-ebpf's own value behind.
...
// restoreTCSysctlStates reverts the settings sing-ebpf changed.
//
